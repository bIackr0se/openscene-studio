...
export const REQUIRED_PUBLIC_PATHS = [
  ...
  'assets/submission/screenshots/05-native-webmcp-proof.jpg',
  ...
  'scripts/validate-studio-narration.mjs',
  ...
  'tests/studio-narration.test.mjs',
